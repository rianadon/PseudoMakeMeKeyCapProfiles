...
//    [17.16,  17.16,   6.5, 	 6.5, 10.0,    0,    0,    15,     0,     0,   2,   2,      1,      5,      1,    3.5,     2,       2], //R4 8
    ...
    [21.86,  17.16,   6.5, 	 6.5,   15,    0,  -.5,    20,     0,     0,   2,   2,      1,      5,      1,    3.5,     2,       2], //R1
    //1.5u 10~13
    ...
    [26.66,  17.16,   6.5, 	 6.5,   15,    0,  -.5,    20,     0,     0,   2,   2,      1,      5,      1,    3.5,     2,       2], //R1
    //1.75u 14~17
    ...
    [31.40,  17.16,   6.5, 	 6.5,   15,    0,  -.5,    20,     0,     0,   2,   2,      1,      5,      1,    3.5,     2,       2], //R1
    //2.0u  18~22
...
//FFwd1 FFwd2 FPit1 FPit2  DshDep DshHDif FArcIn FArcFn FArcEx     BFwd1 BFwd2 BPit1 BPit2  BArcIn BArcFn BArcEx
  ...
  [ 6.4,  3.2,   13,   30,      5,    1.9,  12.4,    22,     2,        5,  4.4,   10,  -50,   12.4,    19,     2], //R1
  //1.5
  ...
  [ 6.4,  3.2,   13,   30,      5,    1.9,  15.8,    28,     2,        5,  4.4,   10,  -50,   15.8,    23,     2], //R1
  //1.75
  ...
  [ 6.4,  3.2,   13,   30,      5,    1.9,  18.7,    33,     2,        5,  4.4,   10,  -50,   18.7,    29,     2], //R1
  //2
